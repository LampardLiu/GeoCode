...
namespace GeoCode
{
    ...
    public class GeoCode
    {
        ...
        /// </param>       
        /// <returns></returns>
        public static AddressResult Gecode(string lng, string lat, MapType mapType)
        {
            IGeoCodeConfig config = GeoCodeConfigManager.GetConfig(mapType.ToString());
            AddressResult address = null;
            LoggerManager.LogTimeInfo(() =>
        ...
        /// </param>       
        /// <returns></returns>
        public static AddressResult Gecode(string lngAndLat, MapType mapType)
        {
            if (string.IsNullOrEmpty(lngAndLat))
                throw new ArgumentNullException();
            var lngLat = lngAndLat.Split(',');
        ...
        /// <returns>解析结果</returns>
        /// <exception cref="Exception，解析失败返回异常"></exception>
        public static Dictionary<string, AddressResult> Gecodes(Dictionary<string, string> keyAndLngLat, MapType mapType)
        {
            Dictionary<string, AddressResult> result = new Dictionary<string, AddressResult>();
            LoggerManager.LogTimeInfo(() =>
            {
